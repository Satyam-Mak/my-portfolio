        ...
        <div className="WRAPPER mt-12 ">
          ...
          >
            <Exp_prop
              ...
              subtitle="Ypsilon IT Solutions Pvt. Ltd"
              date="May 2022 - Oct 2022"
              para="-  Constructed a REST API that connects learning management systems using FastAPI and PostgreSQL; enhanced
 overall system performance, which is now capable of handling 10,000+ requests per minute effortlessly."
            />
            {/* <Exp_prop
              img={KDE}
